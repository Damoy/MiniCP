...
import static minicp.search.Selector.minRegret;

import java.util.Random;

public class TSPMinRegretLNS {
...
//                {121, 518, 142, 84, 297, 35, 29, 36, 236, 390, 238, 301, 55, 96, 153, 336, 0}};
        ...
        DFSearch dfs = makeDfs(cp,
                minRegret(succ,
                        filter -> filter.getSize() > 1, // filter
                        succi -> {
                        	int i = getIndex(succ, succi);
        ...
        dfs.onSolution(() -> {
            ...
            System.out.println("--- SOLUTION : " + totalDist + " ---");
        });
        ...
        for (int i = 0; i < nRestarts; i++) {
            ...
            try {
            	...
            	System.out.println("Last solution was optimal.");
                cp.pop();
                break;
            }

            SearchStatistics stats = dfs.start(statistics -> statistics.nFailures >= failureLimit);
            
            if(stats.nSolutions > 0) {
    ...
    /**
     * Get the index of succi in the succ array.<br>
     */
    public static int getIndex(IntVar[] succ, IntVar succi) {
    ...
    /**
     * Get the index in the array of the minimum value contained in the succi domain.<br>
     */
    public static int getMinIndex(int[] array, IntVar succi) {
